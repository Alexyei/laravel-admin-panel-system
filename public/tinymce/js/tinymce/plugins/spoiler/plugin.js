...
tinymce.PluginManager.add('spoiler', function(editor, url)
{
  ...
  {
    editor.ui.registry.addIcon('removespoiler', '<svg width="24" height="24"><use xlink:href="' + url + '/img/spoiler_icons.svg#addspoiler"></use></svg>');
    editor.ui.registry.addIcon('addspoiler', '<svg width="24" height="24"><use xlink:href="' + url + '/img/spoiler_icons.svg#removespoiler"></use></svg>');
  }
  ...
  function addSpoiler()
  {
    ...
    if (node) {
      ...
      selection.setContent('<div class="spoiler">' +
                           '<div class="spoiler-header">' + spoilerCaption + ' </div>' +
