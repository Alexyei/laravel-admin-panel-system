...
<head>
    ...
    <link rel="stylesheet" href="{{asset('styles/vendors/mdi/css/materialdesignicons.min.css')}}" />
{{--    <link rel="stylesheet" href="assets/vendors/flag-icon-css/css/flag-icon.min.css" />--}}
{{--    <link rel="stylesheet" href="assets/vendors/css/vendor.bundle.base.css" />--}}
    <link rel="stylesheet" href="{{asset('styles/vendors/font-awesome/css/font-awesome.min.css')}}" />
...
<div class="container-scroller">
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
            <a class="sidebar-brand brand-logo" href="{{route('main')}}"><img src="assets/images/logo.svg" alt="logo" /></a>
...
<script src="{{asset('scripts/assets/vendors/flot/jquery.flot.categories.js')}}"></script>
<script src="{{asset('scripts/assets/vendors/flot/jquery.flot.fillbetween.js')}}"></script>
