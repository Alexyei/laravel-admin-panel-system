...
<div class="forms-container">
    <div class="signin-signup">
        ...
        <form autocomplete="off" action="{{route('register', ['verifyUser'=>request()->route('verifyUser')])}}" method="post" class="sign-up-form registration">
            @csrf
...
<div class="panels-container">
    <div class="panel left-panel">
        <div class="content">
            @if (request()->route('verifyUser'))
            <h3>Приглашение</h3>
            <p>
                Зарегистрируйтесь на сайте по ссылке от: <?= $this->routeParams['ref'] ?>
            </p>
            @else
            <h3>Впервые здесь ?</h3>
            <p>
